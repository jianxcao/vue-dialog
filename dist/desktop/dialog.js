/*!
 * dialog.js v1.0.1
 * (c) 2014-2019 jianxcao
 * Released under the MIT License.
 */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue')) :
	typeof define === 'function' && define.amd ? define(['exports', 'vue'], factory) :
	(global = global || self, factory(global.dialog = global.dialog || {}, global.Vue));
		...
		if (isVnode(content)) {
			...
			var mixin = {
				...
				data: function data () {
					...
					return ( obj = {}, obj[ref + 'Data'] = instances[ref + 'Data'], obj.dialogData = instances[ref + 'Data'], obj );
				}
			};
			var component;
					...
					while (target) {
						if (target.nodeType === 1) {
							...
							if (action === 'btn' || action === 'close') {
								...
								var results = this._$$emit('btnClick', ret);
	 ...
	 */
	function install (dialog, dialogComponent) { return function install (Vue) {
		if (installed) {
			return;
		}
		installed = true;
